            ...
            <main className="hero relative w-full h-screen text-white overflow-hidden">
                ...
                <div className="hero-content relative z-10 flex flex-col items-center justify-center h-full text-center">
                    ...
                    <div className="flex items-center justify-center mt-5">
                        <a href="" className="px-6 py-2 rounded-xl bg-white text-black font-bold hover:bg-gray-200 hover:text-black transition hover:scale-105 duration-500">Contacto</a>
                        <a href="" className="px-6 py-2 rounded-xl bg-white text-black font-bold hover:bg-gray-200 hover:text-black transition hover:scale-105 duration-500 ml-5">Proyectos</a>
                    </div>
