...
export default function services(){
    return (
        ...
        <section className="services mt-50 w-full">
            <div className=" flex flex-col lg:flex-row justify-between items-center w-full px-5 lg:px-15">
                <div>
                    <h1 className="text-[2.5rem] lg:text-2xl font-bold mb-5">
                        TE OFRECEMOS
                    </h1>
            ...
            <div className="flex lg:flex-row flex-col gap-10 mt-10 px-5 lg:px-20">
        ...
        <div className="ContactSection relative mt-50 mb-50 px-8 lg:px-40 min-h-[600px] w-[90%] mx-auto
